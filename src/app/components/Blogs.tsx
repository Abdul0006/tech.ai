  ...
  return (
    <section className='py-20 container max-w-7xl mx-auto px-4'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
        {
          blogs.map((blog)=>(
            <article key={blog.slug} className='bg-white mb-8 dark:bg-gray-800 rounded-lg shadow-md p-6 '>
      ...
      <div className='text-center mt-12'>
        <Link href="/blogs" className='inline-block bg-primary text-white px-6 py-3 rounded-lg hover:bg-primary/60 transition-colors'>
          View All Blogs
        </Link>
      </div>
    </section>
